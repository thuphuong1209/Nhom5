...
const Login = () => {
  ...
  return (
    <div className="border px-5 py-5 mt-1 ">
      <div className='text-center'> <img src="https://upload.wikimedia.org/wikipedia/commons/2/25/Logo_Kinh_t%E1%BA%BF_%C4%90%C3%A0_N%E1%BA%B5ng.jpg"
      ...
      <Form>
        ...
        <Form.Group className="mb-3" controlId="formBasicPassword">
          ...
          <Form.Control ref={password} type="password" placeholder="Nhập mật khẩu" />
        </Form.Group>
